# -*- coding: utf-8 -*-
"""
Created on Sun Sep  3 21:05:35 2023
...
folder_path = 'C:\\Users\\ADMIN\Downloads\\transformer_codes\\oneshot_reactiveregion_horizontal'  # Replace with the desired path
...
for head_size in head_sizeS:
    ...
    #pd.concat([data_full_filtered.iloc[1:6], data_full_filtered.iloc[10:16]])                
                    for r in R:
                    ...
                    data = data_full[['z',label, 'RSI', 'EMAF', 'EMAM', 'EMAS', 'TargetNextClose']]
                    ...
                    plt.savefig(folder_path+"\\TV_"+"seq"+str(backcandles)+"_headsize"+str(head_size)+"_numheads"+str(num_heads)+"_ffdim"+str(ff_dim)+"_blocks"+str(num_transformer_blocks)+".jpg", format='jpg')
                    plt.show()
                    plt.close()
                    ...
                    plt.title("Label\n"+"sequence length is "+str(backcandles)+"head_size is "+str(head_size)+"\n"+"num_heads is "+str(num_heads)+"\n"+"ff_dim is "+str(ff_dim)+"\n"+"num_transformer_blocks is "+str(num_transformer_blocks)+"\n"+"\n", fontweight = 'bold')
                    plt.savefig(folder_path+"\\PA_"+"seq"+str(backcandles)+"_headsize"+str(head_size)+"_numheads"+str(num_heads)+"_ffdim"+str(ff_dim)+"_blocks"+str(num_transformer_blocks)+".jpg", format='jpg')
                    plt.show()
                    plt.close()
